...
class LaneDetector(object):
    def __init__(self, color):
        ...
        if os.environ["DEPTH_CAMERA_TYPE"] == "ascamera":
            self.rois = (
                (338, 360, 0, 320, 0.7),  # 박스 1 (기존 1번)
                (315, 338, 0, 320, 0.0),  # TODO 01 : 박스 2 (새로 추가)
                (293, 315, 0, 320, 0.2),  # 박스 3 (기존 2번)
                (270, 293, 0, 320, 0.0),  # TODO 01 : 박스 4 (새로 추가)
                (248, 270, 0, 320, 0.1),  # 박스 5 (기존 3번)
            )
        else:
            self.rois = (
